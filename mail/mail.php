...
$sendingAccountUsername     = 'oskars@developers-alliance.com';
$sendingAccountPassword     = 'K0k0k00la123';

// Recipient (To:) Details  - Change this to the email details of who will receive all the emails from the website.
$recipientEmail             = 'oskars@developers-alliance.com'; // REQUIRED value.
$recipientName              = 'Oskars Tuns';             // REQUIRED value.

// Email details            - Change these to suit your website needs
$emailSubject               = 'A message from Your Website'; // REQUIRED value. Subject of the email that the recipient will see
$websiteName                = 'developers-alliance.com';                // REQUIRED value. This is used when a name or email is not collected from the website form

$timeZone					= 'Europe/Riga';         // OPTIONAL, but some servers require this to be set.
